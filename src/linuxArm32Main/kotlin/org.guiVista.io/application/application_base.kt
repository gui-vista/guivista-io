...
public actual interface ApplicationBase : ActionMap, ObjectBase {
     ...
     * @return The handler ID.
     */
    public fun connectStartupSignal(slot: CPointer<StartupSlot>, userData: gpointer): UInt =
     ...
     * @return The handler ID.
     */
    public fun connectShutdownSignal(slot: CPointer<ShutdownSlot>, userData: gpointer): UInt =
     ...
     * @return The handler ID.
     */
    public fun connectOpenSignal(slot: CPointer<OpenSlot>, userData: gpointer): UInt =
